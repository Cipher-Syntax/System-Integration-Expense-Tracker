                    ...
                    <div className="bg-white/80 backdrop-blur-xl rounded-2xl shadow-2xl p-8 border border-white/20">
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        required
                                        className="w-full pl-10 pr-12 py-2.5 bg-gray-50 border-2 border-gray-200 rounded-lg 
                                                   focus:outline-none focus:border-pink-500 focus:bg-white transition-all duration-300 
                            ...
                            <button
                                ...
                                disabled={loading}
                                className="w-full bg-gradient-to-r from-pink-500 to-pink-600 text-white font-bold py-2.5 rounded-lg 
                                           hover:shadow-lg hover:shadow-pink-500/30 transition-all duration-300 disabled:opacity-70 
                                           disabled:cursor-not-allowed text-sm cursor-pointer"
                            >
